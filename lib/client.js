...
try {
    ...
    console.log("Connected to the RAHUL-MD-BOT Whatsapp Bot By Rahul Debnath")
} catch {
...
let cc= name.sessionName.replace(/RAHUL-MD;;;/g, "");
var Zubair = false;
...
setTimeout(() => {
    ...
    global.slogo = 'https://telegra.ph/file/ba7201b533cf2264f2237.jpg'
    global.sgc = 'https://chat.whatsapp.com/C7PFcSRmRI9Enbda8Cikqu'
    global.srepo = 'https://github.com/Tahul121/RAHUL-MD-BOT'
    global.scap = '*⤹★ᴘᴏᴡᴇʀᴇᴅ ʙʏ★⤸ ʀᴀʜᴜʟ ᴹᴰ* '
    global.sgen = `*╰┈➤ 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ${name.botname}*`
    global.snam = 'ʀᴀʜᴜʟ ᴹᴰ'
    global.scate  = `
┏━━⟪⟪ ${mztit} ⟫━⦿       
